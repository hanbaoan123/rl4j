 ...
 */
@AllArgsConstructor
public class DQNPolicySchedule<O extends Encodable> extends Policy<O, Integer> {

	final private IDQN dqn;

	public static <O extends Encodable> DQNPolicySchedule<O> load(String path) throws IOException {
		return new DQNPolicySchedule<O>(DQN.load(path));
	}
